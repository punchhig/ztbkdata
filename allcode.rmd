...
library(tidyverse)
library(lubridate)
x=read.csv("C:/Users/g_pun/Dropbox/ZeroTB/ztbkdata/ZTBK_LowerTCV_2017JUL10_TCV_Lower.csv",stringsAsFactors = FALSE, na.strings=TRUE)
...
```{r export}
write.csv(x,"ZTBK_LowerTCV_2017JUL10_TCV_Lower.csv", na="")
```